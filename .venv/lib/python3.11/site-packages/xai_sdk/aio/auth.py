...
class Client(BaseClient):
    """Asynchronous client for interacting with the `Auth` API."""

    async def get_api_key_info(self) -> auth_pb2.ApiKey:
        """Retrieve metadata about the API key used to instantiate the client.
